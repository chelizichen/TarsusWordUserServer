...
export class getUsersByIdsReq {
    public ids: Array<number>;
    constructor(...args: any[]) {
        const _TarsusReadStream = new TarsusReadStream("getUsersByIdsReq", args);
        this.ids = _TarsusReadStream.read_list(1, "List<int>");
    }
};
export class getUsersByIdsRes {
    public list: Array<UserCache>;
    constructor(...args: any[]) {
        const _TarsusReadStream = new TarsusReadStream("getUsersByIdsRes", args);
        this.list = _TarsusReadStream.read_list(1, "List<UserCache>");
    }
};
export class UserCache {
    ...
    public user_id: string;
    constructor(...args: any[]) {
        const _TarsusReadStream = new TarsusReadStream("UserCache", args);
        this.user_name = _TarsusReadStream.read_string(1);
